			...
			<%
				...
				*/
				...
				/*
					...
					All execution methods in the Statement interface implicitly close a current ResultSet object of the statement
					if an open one exists.
				*/
				stat.close();
				conn.close();		//ResultSet对象与Connection对象实现了紧密的绑定，所以conn不能提前close
			%>
